...
const Admin = () => {
    ...
    //         ipfs.files.add(hospitalBuffer, (error, result) => {
    //             if (error) {
    //                 window.alert("Failed to add file to IPFS");
    //                 console.log(error);
    //             }
    //             setIpfsHash(result[0].hash);
    //             console.log("The hash file is " + ipfsHash);
    //         })

    //         await contract.methods.addHospital(hospital.name, hospital.address, hospital.ethAdd.trim(), ipfsHash).send({ from: accounts[0] });
    //         await updateIds();
    //         window.alert("Hospital Registered Successfully "+ hospital.ethAdd);
    //     } catch (error) {
    ...
    //         ipfs.files.add(orgBuffer, (error, result) => {
    //             if (error) {
    //                 window.alert("Failed to add file to IPFS");
    //                 console.log(error);
    //             }
    ...
    //         await contract.methods.addOrganization(org.name, org.ethAdd.trim(), ipfsHash).send({ from: accounts[0] });
    //         await updateIds();
    //         window.alert("Organization Registered Successfully "+ org.ethAdd);
    //     } catch (error) {
                        ...
                        <div>
                            ...
                            <form >
                                <div className="row">
                                    ...
                                    <div className="col-md-4 form-group py-1">
                                        <input type="file" name="name" className="form-control" id="license" required />
